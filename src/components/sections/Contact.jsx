...
export const Contact = () => {
    ...
    return (
        <section id="contact" className="min-h-screen flex items-center justify-center py-20">
            <RevealOnScroll>
                <div className="bg-black px-4 w-full min-w-[300px] md:w-[500px] sm:w-2/3 p-6 rounded-xl shadow-xl backdrop-blur-lg">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="relative">
                            <input
                                ...
                                required
                                value={formData.name}
                                className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-white transition focus:outline-none focus:border-pink-500 focus:bg-pink-500/10"
                                placeholder="Namn..."
                        ...
                        <button type="submit" disabled={isSending}
                            className={`w-full bg-pink-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden ${isSending ? 'opacity-50 cursor-not-allowed' : 'hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(255,105,180,0.6)]'}`}>
